...
void webServerRun(void) {
  ...
  webServerPrintProgmem(client, webServerWifiFormBegin);

  webServerPrintProgmem(client, webServerWifiFormInputBegin);
  webServerPrintProgmem(client, webServerWifiFormNameSsid);
  webServerPrintProgmem(client, webServerWifiFormInputInput);
  webServerPrintProgmem(client, webServerWifiFormParameterSsid);
  webServerPrintProgmem(client, webServerWifiFormInputValue);
  client.print(wifiSsid);
  webServerPrintProgmem(client, webServerWifiFormInputEnd);

  webServerPrintProgmem(client, webServerWifiFormInputBegin);
  webServerPrintProgmem(client, webServerWifiFormNamePassword);
  webServerPrintProgmem(client, webServerWifiFormInputInput);
  webServerPrintProgmem(client, webServerWifiFormParameterPassword);
  webServerPrintProgmem(client, webServerWifiFormInputValue);
  client.print(wifiPassword);
  webServerPrintProgmem(client, webServerWifiFormInputEnd);

  webServerPrintProgmem(client, webServerWifiFormInputBegin);
  webServerPrintProgmem(client, webServerWifiFormNameAuth);
  webServerPrintProgmem(client, webServerWifiFormInputInput);
  webServerPrintProgmem(client, webServerWifiFormParameterAuth);
  webServerPrintProgmem(client, webServerWifiFormInputValue);
  client.print(authToken);
  webServerPrintProgmem(client, webServerWifiFormInputEnd);

  webServerPrintProgmem(client, webServerWifiFormEnd);
